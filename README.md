...
Как работает авто-режим: VAD на Web Audio API (анализ RMS, авто-калибровка шума,
выбор чувствительности). На время ответа слух выключается, чтобы система не
«слышала» сама себя; для сложной акустики лучше гарнитура. Это pure-frontend,
