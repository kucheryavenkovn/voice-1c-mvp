...
и группирует сумму по складам. Спрашивать можно и названием, и кодом:
*«какой остаток по молоку?»*, *«по артикулу 7777»*, *«сколько по 45463728»*.
Ответ: «Барбарис (конфеты) (арт. Арт-7777): всего 210 единиц. По складам: …» или,
если совпадений несколько — «По '7777' найдено 3: …». Подробности: [docs/1C_INTEGRATION.md](docs/1C_INTEGRATION.md).
