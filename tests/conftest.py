...
ONEC_SINGLE = (
    ...
    "  Центральный склад,Молоко 3.2%,Арт-1,20\n"
    "  Торговый зал,Молоко 3.2%,Арт-1,30"
)
ONEC_MULTI = (
    '[3]{"Склад","Товар","Артикул","Остаток"}:\n'
    "  Склад1,Барбарис,Арт-7777,10\n"
    '  "Магазин \\"Продукты\\"",Молоко,Арт-777788,5\n'
